...
const ResourceCard: React.FC<ResourceCardProps> = ({ resource }) => {
    ...
    return (
        <SlideUp delay={0.1}>
            <div className="group relative bg-white rounded-2xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_12px_24px_rgba(63,41,101,0.08)] hover:scale-[1.01] transition-all duration-300 border border-slate-100 hover:border-primary/20 flex flex-col h-full ring-1 ring-slate-100/50">
