...
interface LoaderProps {
  fullScreen?: boolean;
  message?: string; // Made optional to prevent errors if omitted
}
  ...
  return (
    ...
    >
      <div className="relative flex items-center justify-center w-32 h-32">
        ...
        {/* 🌸 Ring 2: The Pink Accelerator (Fast, Dynamic Spin) */}
        <motion.div
          animate={{ rotate: -360 }}
        ...
        {/* 🖼️ The Logo (Floating freely, no background circle) */}
        <motion.div
