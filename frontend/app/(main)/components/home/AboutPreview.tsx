      ...
      <div className="max-w-[1440px] mx-auto w-full relative overflow-visible z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center mb-14">
          ...
          <div className="flex flex-col items-center text-center order-2 lg:col-span-6">
            ...
            <div className="mb-8">
              <Reveal delay={0.2}>
                <div className="relative inline-block">
                  <div className="text-xl sm:text-2xl md:text-3xl font-medium text-[#3F2965]/90 italic max-w-2xl leading-relaxed">
            ...
            {/* Description */}
            <SlideUp delay={0.3} className="max-w-xl mx-auto">
          ...
          {/* Right Column: Mental Health SVG */}
          <div className="w-full flex justify-center lg:justify-end order-3 lg:col-span-3 mt-8 lg:mt-0">
             <div className="w-full max-w-[280px] sm:max-w-[320px] lg:max-w-[380px]">
...
// Sub-component for the new "Peace of Mind" SVG
function PeaceOfMindIllustration() {
  return (
    <Image
      ...
      width={500}
      height={500}
      className="animated w-full h-auto"
    />
  );
}
