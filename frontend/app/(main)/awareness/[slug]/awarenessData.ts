...
export const awarenessContent: Record<string, AwarenessContent> = {
  anxiety: {
    ...
    heroImage: "/awareness_hero/new_anxiety.jpg",
  ...
  stress: {
    ...
    slug: "stress",
    category: "Mental Health",
    heroImage: "/awareness_hero/new_stress.jpg",
  ...
  "self-esteem": {
    ...
    heroImage: "/awareness_hero/new_Self-Esteem-2.jpeg",
  ...
  trauma: {
    ...
    slug: "trauma",
    category: "Mental Health",
    heroImage: "/awareness_hero/new_trauma.jpg",
