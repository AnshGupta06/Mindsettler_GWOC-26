...
{content.statistics && (
  <SlideUp>
    <section className="relative bg-gradient-to-br from-primary  via-primary/90 to-accent rounded-3xl p-8 md:p-14 text-white overflow-hidden shadow-2xl">
      ...
      <StaggerContainer delay={0.1}>
        <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
          {content.statistics.map((stat, idx) => (
            <StaggerItem key={idx}>
              <div className="group h-full bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-7 border border-white/20 transition-all duration-300 hover:bg-white/20 hover:-translate-y-1 hover:shadow-2xl">
                
                {/* Value */}
                <div className="text-4xl md:text-5xl font-extrabold mb-3 tracking-tight">
                  {stat.value}
                </div>
          ...
          <div className="group h-full bg-white rounded-2xl p-8 md:p-9 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
            ...
            <ul className="space-y-2 text-sm md:text-base text-gray-700">
              ...
              <li className="flex items-center gap-2">
               ...
               {/* CTA Section */}
<SlideUp>
  <section className="relative bg-gradient-to-br from-primary via-primary/90 to-accent rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl overflow-hidden">
    ...
    <div className="relative max-w-3xl mx-auto space-y-7">
      ...
      <StaggerContainer delay={0.25}>
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
          ...
          <StaggerItem>
            <button className="group relative px-10 py-4 rounded-full border-2 border-white text-white font-semibold transition-all duration-300 hover:bg-white hover:text-primary hover:-translate-y-1">
              Learn More
            </button>
          </StaggerItem>
